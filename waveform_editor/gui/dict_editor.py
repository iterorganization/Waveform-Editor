...
class DictEditor(pn.widgets.CompositeWidget):
    ...
    def __init__(self, names, key_options=None, **params):
        """Initialize the DictEditor widget.

        Args:
            names: Tuple of column names to display for keys and values.
            key_options: List of allowed keys shown in a dropdown editor. When None,
                the key column is instead free text (e.g. user-chosen import names).
        """
        key_editor = (
