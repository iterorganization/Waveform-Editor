...
.. note::
  ...
  With ``outputForControl`` set to 1, NICE writes the A, B and C matrices of the
  linearized model as text files, relative to the directory the waveform editor was
